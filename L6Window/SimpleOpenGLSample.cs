...
namespace L6Window
{
    public class SimpleOpenGLSample : GameWindow
    {
            ...
            : base()
        {
            ...
            String fileName = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "nanosuit.obj");
                ...
                foreach (int index in node.MeshIndices)
                {
                    ...
                    foreach (Face face in mesh.Faces)
                    {
                        ...
                        for (int i = 0; i < face.IndexCount; i++)
                        {
                            ...
                            if (hasColors)
                            {
                                OpenTK.Graphics.Color4 vertColor = FromColor(mesh.VertexColorChannels[0][indice]);
                            }
                            if (mesh.HasNormals)
                            {
        ...
        private void ApplyMaterial(Material mat)
        {
            ...
            OpenTK.Graphics.Color4 color = new OpenTK.Graphics.Color4(.8f, .8f, .8f, 1.0f);
            ...
            color = new OpenTK.Graphics.Color4(0, 0, 0, 1.0f);
            ...
            color = new OpenTK.Graphics.Color4(.2f, .2f, .2f, 1.0f);
        ...
        private OpenTK.Graphics.Color4 FromColor(Color4D color)
        {
